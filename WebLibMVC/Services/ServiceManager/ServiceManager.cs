using AutoMapper;
using ServiceMVC.AuthorizeService;
...
namespace ServiceMVC.ServiceManager
{
    public class ServiceManager : IServiceManager
    {
        ...
        private readonly Lazy<IAuthorizeService> _authorizeService;
        ...
        public ServiceManager(IHttpClientFactory clientFactory, IMapper mapper)
        {
            ...
            _authorizeService = new Lazy<IAuthorizeService>(() => new AuthorizeService.AuthorizeService(clientFactory, mapper));
        }
        ...
        public IAuthorizeService AuthorizeService => _authorizeService.Value;
    }
}
